...
class Quote(Base):
    ...
    __table_args__ = (
        Index("billing_quotes_tenant_id_number_key", "tenant_id", "number", unique=True),
    ...
    status: Mapped[QuoteStatus] = mapped_column(ENUM(QuoteStatus, name="BillingQuoteStatus"), nullable=False, server_default=text("'DRAFT'"))
...
class QuoteLine(Base):
    ...
    __table_args__ = (
        ...
        ForeignKeyConstraint(["quote_id"], ["billing_quotes.id"], ondelete="CASCADE", onupdate="CASCADE"),
