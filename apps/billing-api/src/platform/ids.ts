...
const entityPrefixes: Record<string, string> = {
  ...
  BankStatementImport: 'bimp',
  BankStatementLine: 'bsl',
  BankStatementMatch: 'bmatch',
  BankStatementMatchItem: 'bmitem',
  BankRule: 'brule',
  BankRuleCondition: 'brcond',
  BankReconciliation: 'brec',
  BankReconciliationItem: 'brecitem',
  BankTransfer: 'btr',
  BankDeposit: 'bdep',
  BankDepositItem: 'bdepitem',
  PaymentMode: 'pmode',
  Payment: 'pay',
