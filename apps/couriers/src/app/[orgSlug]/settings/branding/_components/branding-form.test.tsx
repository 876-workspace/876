...
vi.mock('@/lib/client/finance', () => ({
  financeBranding: { update: mocks.update },
}))
...
describe('BrandingForm', () => {
  ...
  it('saves the edited branding with the org slug and payload then refreshes', async () => {
    ...
    expect(mocks.update).toHaveBeenCalledWith('island-logistics', {
      ...initial,
      appearance: 'dark',
    })
