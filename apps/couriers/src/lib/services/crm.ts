...
/**
 * Couriers' app-owned, server-only CRM service client. Resource access
 * initializes the singleton at request time because OpenNext imports route
 * modules before runtime secrets are available.
 */
export const crm = {
  get customers() {
