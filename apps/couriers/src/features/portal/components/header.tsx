...
import { PortalAccountMenu } from './account-menu'
...
export function PortalHeader({
  ...
  return (
    <header className="bg-background/95 supports-[backdrop-filter]:bg-background/80 sticky top-0 z-40 border-b-0 backdrop-blur">
