...
export const ENTITY_PREFIXES = {
  ...
  applicationProvisioningProfile: 'apppr',
  applicationProvisioningProfileCondition: 'appc',
  auditEvent: 'aud',
  apiKey: '876_app_key',
  authProvider: 'aup',
  authAttempt: 'atmp',
  ...
  orgLocation: 'loc',
  organization: 'org',
  organizationApplicationProvisioning: 'oap',
  permission: 'per',
  plan: 'pln',
  planModule: 'pmo',
  price: 'prc',
