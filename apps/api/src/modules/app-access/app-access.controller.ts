...
export async function updateAppPermission(req: Request, res: Response): Promise<void> {
  const { app_id, permission_id } = validParams<{
    app_id: string
  ...
  res
    .status(200)
    .json(await service.updateAppPermission(app_id, permission_id, body))
}
...
export async function listOrgAppRoles(req: Request, res: Response): Promise<void> {
  ...
  res
    .status(200)
    .json(await service.listOrgAppRoles(org_id, app_id, principal(req)))
}
...
export async function createOrgAppRole(req: Request, res: Response): Promise<void> {
  ...
  res
    .status(201)
    .json(await service.createOrgAppRole(org_id, app_id, body, principal(req)))
}

export async function retrieveOrgAppRole(req: Request, res: Response): Promise<void> {
  const { org_id, app_id, role_id } = validParams<{
    org_id: string
    app_id: string
    role_id: string
  }>(req)
  res
    .status(200)
    .json(await service.retrieveOrgAppRole(org_id, app_id, role_id, principal(req)))
}
...
export async function listAppMemberships(req: Request, res: Response): Promise<void> {
  ...
  const result = await service.listAppMemberships(org_id, query, principal(req))
  if (query.status && !query.include_revoked)
    result.data = result.data.filter((membership) => membership.status === query.status)
...
export async function createAppMembership(req: Request, res: Response): Promise<void> {
  ...
  res
    .status(201)
    .json(await service.createAppMembership(org_id, body, principal(req)))
}
...
export async function retrieveAppMembership(req: Request, res: Response): Promise<void> {
  ...
  res
    .status(200)
    .json(await service.retrieveAppMembership(org_id, assignment_id, principal(req)))
}
...
export async function updateAppMembership(req: Request, res: Response): Promise<void> {
  ...
  res
    .status(200)
    .json(
      await service.updateAppMembership(org_id, assignment_id, body, principal(req))
    )
}
...
export async function deleteAppMembership(req: Request, res: Response): Promise<void> {
  ...
  res
    .status(200)
    .json(await service.deleteAppMembership(org_id, assignment_id, principal(req)))
}
...
export async function listAppMembershipsForMember(
  ...
  res
    .status(200)
    .json(
      await service.listAppMembershipsForMember(
        org_id,
        membership_id,
        principal(req)
      )
...
export async function listMembersForApp(req: Request, res: Response): Promise<void> {
  ...
  res
    .status(200)
    .json(await service.listMembersForApp(org_id, app_id, principal(req)))
}
