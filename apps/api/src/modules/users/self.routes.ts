...
export function registerSelfRoutes(resolveGuards: GuardResolver) {
  ...
  api.get({
    ...
    request: { params: z.strictObject({ addressId: z.string() }) },
    responses: {
      200: {
        description: 'Address.',
        schema: z.object({
  ...
  api.patch({
    ...
    request: {
      params: z.strictObject({ addressId: z.string() }),
  ...
  api.get({
    ...
    request: { params: z.strictObject({ contactId: z.string() }) },
    responses: {
      200: {
        description: 'Contact.',
        schema: z.object({
  ...
  api.patch({
    ...
    request: {
      params: z.strictObject({ contactId: z.string() }),
