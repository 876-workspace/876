 ...
 * not aliases for the finer canonical finance modules. Commerce intentionally
 * contributes no rows yet: declaring its capability vocabulary in code does not
 * make an unimplemented capability plan-selectable.
 */
