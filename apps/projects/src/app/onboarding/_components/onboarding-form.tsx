      ...
      >
        <div>
          <h1 className="876-page-title">
            {existingOrgName ? 'Add 876 Projects' : 'Set up your organization'}
          </h1>
          <p className="text-muted-foreground mt-1 text-sm">
            {existingOrgName
              ? `Turn on 876 Projects for ${existingOrgName}.`
              : 'Name the organization that will own this Projects workspace.'}
          </p>
        </div>
