...
import { PortalFilesData } from '@/features/portal/components/portal-data'
import { requirePortalAccess } from '@/lib/portal-access'

export const metadata: Metadata = { title: 'Client portal files' }
  ...
  return (
    <div className="space-y-4">
      ...
      <Suspense fallback={<div className="876-card h-64 animate-pulse" aria-hidden />}>
        <PortalFilesData access={access} projectId={decoded} />
      </Suspense>
    </div>
  )
}
