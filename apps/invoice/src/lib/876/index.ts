...
import { create876ServerClient, type Invoice876Client } from '@876/client/server'
import { headers } from 'next/headers'

import { getAuthSession, isSignedSession } from '@/lib/auth/session'

export async function get876Client(organizationId: string): Promise<Invoice876Client> {
