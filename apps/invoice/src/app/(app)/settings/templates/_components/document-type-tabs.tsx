...
function typeHref(type: DocumentTemplateType): string {
  return `/settings/templates?type=${type}`
}

/** Server-rendered tab row; the active tab is known from search params. */
export function DocumentTypeTabs({ active }: { active: DocumentTemplateType }) {
  return (
    <nav
