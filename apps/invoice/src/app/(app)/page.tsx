    ...
    <Page>
      ...
      <div className="876-card mt-6 p-5">
        ...
        <p className="text-muted-foreground mt-2 text-sm">
          Create a customer, add an item, then draft your first quote or invoice
          — the same flow as 876 Billing, streamlined for invoicing.
        </p>
      </div>
    </Page>
  )
