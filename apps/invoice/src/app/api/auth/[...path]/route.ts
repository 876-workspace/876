...
/**
 * Forwards `/api/auth/*` to the core API with this app's key attached, so the
 * API seals the session cookie on Invoice's own origin. Pure transport — the
 * app owns no auth logic.
 */
async function proxyAuthRequest(
  ...
  // Invoice is an org workspace: the people signing in are org members acting
  // for their organization, not consumers.
