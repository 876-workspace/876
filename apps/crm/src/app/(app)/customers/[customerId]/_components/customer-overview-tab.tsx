...
/**
 * The Overview tab body — party details, the primary contact for a business
 * customer, and the CRM record fields.
 *
 * Extracted from the card so each tab owns one file and one route; the card is
 * now just the frame around whichever tab is active.
 */
