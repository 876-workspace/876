...
/**
 * GET /callback — WorkOS social-auth landing for the Billing app.
 *
 ...
 * return-to cookie, and redirect in. Access is still enforced downstream — a
 * valid session without the necessary permissions lands on access-denied.
 *
 ...
 * e.g. `https://*-3004.app.github.dev/callback`.
 */
