...
function member(
  overrides: Partial<import('@876/access-ui/member-types').OrgMember> = {}
): import('@876/access-ui/member-types').OrgMember {
  return {
...
describe('Billing UsersList', () => {
  ...
  it('filters members by status', () => {
    navigation.segments = []
    navigation.searchParams = new URLSearchParams('status=suspended')
    render(
      <UsersList
        members={[
          member(),
