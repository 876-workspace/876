...
async function CustomersData({
  ...
  return (
    <CustomersTable
      ...
      baseHref={`${workspaceBase(slug, workspaceKey)}/customers`}
      emptyState={
...
async function PaymentsData({
  ...
  return (
    <PaymentsTable
      ...
      baseHref={`${workspaceBase(slug, workspaceKey)}/payments`}
      emptyState={
        <p className="text-muted-foreground py-10 text-center text-sm">
...
async function BankingData({
  ...
  return (
    <BankAccountsGrid
      ...
      baseHref={`${workspaceBase(slug, workspaceKey)}/banking`}
      emptyState={
        <p className="text-muted-foreground py-10 text-center text-sm">
  ...
  return (
    <>
      ...
      <InvoicesTable
        ...
        baseHref={`${workspaceBase(slug, workspaceKey)}/invoices`}
        emptyState={
          <p className="text-muted-foreground py-10 text-center text-sm">
...
async function ItemsData({
  ...
  return (
    <ItemsTable
      ...
      baseHref={`${workspaceBase(slug, workspaceKey)}/items`}
      emptyState={
        <p className="text-muted-foreground py-10 text-center text-sm">
          {emptyLine}
        </p>
