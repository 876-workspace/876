...
/**
 * GET /callback — WorkOS social-auth landing for Console.
 *
 ...
 * return-to cookie, and redirect in. Console access is still enforced
 * downstream — a valid session without admin permissions lands on access-denied.
 *
 * The `{origin}/callback` URL must be registered in the WorkOS dashboard —
 * e.g. `https://*-3002.app.github.dev/callback`.
 */
