...
export const addressCreateBodySchema = z
...
export const addressParamsSchema = tenantIdParamsSchema.extend({
  id: z.string().min(1),
})
...
export type AddressCreateBody = z.infer<typeof addressCreateBodySchema>
