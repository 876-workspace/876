...
beforeEach(() => {
  ...
  repository.list.mockResolvedValue([teamRow] as unknown as ReturnType<
    typeof repository.list
  >)
  repository.retrieve.mockResolvedValue(
    teamRow as unknown as ReturnType<typeof repository.retrieve>
  )
  repository.create.mockResolvedValue(
    teamRow as unknown as ReturnType<typeof repository.create>
  )
  repository.update.mockResolvedValue(
    teamRow as unknown as ReturnType<typeof repository.update>
  )
})
