...
describe('categories.schemas - create', () => {
  ...
  it('accepts all optional fields', () => {
    ...
    expect(parsed.defaultPriority).toBe('HIGH')
  })
  ...
  it('rejects invalid priority', () => {
    expect(() =>
      create.parse({ ...base, defaultPriority: 'CRITICAL' })
    ).toThrow()
  })
  it('accepts null defaults', () => {
    ...
    expect(
      create.parse({ ...base, defaultPriority: null }).defaultPriority
    ).toBeNull()
  })
...
describe('categories.schemas - update', () => {
  ...
  it('allows clearing defaults with null', () => {
    ...
    expect(update.parse({ defaultPriority: null }).defaultPriority).toBeNull()
  })
