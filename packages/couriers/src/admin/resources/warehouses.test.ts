...
const warehouse = {
  ...
  id: warehouseId,
  tenantId: tenantId,
  addressId: 'addr_kingston_harbour_56',
  orgLocationId: 'orgloc_kingston_harbour',
  name: 'Kingston Harbour Depot',
  operatingModel: 'OWNED' as const,
  agentName: null,
  code: 'KIN-HARB',
  mailboxPlacement: 'RECIPIENT_LINE' as const,
  mailboxPrefix: 'KIN',
...
const createBody = {
  ...
  operatingModel: 'AGENT' as const,
  agentName: 'Freeport Logistics Jamaica',
  code: 'MBJ-FREE',
  mailboxPlacement: 'ADDRESS_LINE_2' as const,
  mailboxPrefix: 'MBJ',
