    ...
    >
      ...
      <div
        ...
        className={cn(
          ...
          variant === 'floating' || variant === 'inset'
            ? 'w-[calc(var(--sidebar-width)-var(--876-shell-gutter))] group-data-[collapsible=icon]:w-[calc(var(--sidebar-width-icon)+var(--876-shell-gutter)+2px)]'
      ...
      <div
        ...
        className={cn(
          ...
          variant === 'floating' || variant === 'inset'
            ? 'px-[var(--876-shell-gutter)] py-2 group-data-[collapsible=icon]:w-[calc(var(--sidebar-width-icon)+(var(--876-shell-gutter)*2)+2px)]'
