...
import { createWorkIntegrationRuntime, type WorkIntegrationClientOptions } from './runtime'

/** Creates the organization-scoped 876 Work integration client. */
export function create876WorkIntegrationClient(options: WorkIntegrationClientOptions = {}) {
...
export type WorkIntegrationClient = ReturnType<typeof create876WorkIntegrationClient>
