...
export function createPricesResource(billing: BillingClient | BillingIntegrationClient | undefined) : any {
  if (!billing) return undefined as unknown as BillingClient['prices']
  return (billing as unknown as any as { prices: BillingClient['prices'] }).prices
}
