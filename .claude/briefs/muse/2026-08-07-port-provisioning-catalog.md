# Brief — port services/provisioning_catalog.py services/organization_bootstrap.py to Express/TypeScript

**Working directory:** `/workspaces/876/apps/api`

## The goal

Port the Python service(s) `services/provisioning_catalog.py services/organization_bootstrap.py` to `src/services/provisioning-catalog.ts src/services/organization-bootstrap.ts`, behaviour-identical,
...
- `src/services/provisioning-catalog.ts src/services/organization-bootstrap.ts`
