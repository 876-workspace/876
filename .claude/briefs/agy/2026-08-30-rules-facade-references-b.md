...
| #   | File                                    | Mentions |
| --- | --------------------------------------- | -------- |
| 1   | `.claude/rules/feature-flags.md`        | 1        |
| 2   | `.claude/rules/shared-product-ui.md`    | 3        |
| 3   | `.claude/rules/storage-architecture.md` | 1        |
| 4   | `.claude/rules/new-app-guide.md`        | 7        |
...
**A second agent is editing `app-access.md`, `app-layout.md`, `app-structure.md`, `billing-data-plane.md`, `customer-architecture.md`, `data-loading.md` at the same time. Do not open, read-modify, or write any of those files.**
...
trees stay byte-identical for these ten files. That is 8 file edits in total.
...
When you are finished, write `.claude/reports/agy/2026-08-30-rules-facade-references-b.md`
containing:
