# Give every `src/lib/` module its own folder — APPS: `apps/console` (29 files), `apps/projects` (18), `apps/billing` (11)
...
`apps/console` (29 files), `apps/projects` (18), `apps/billing` (11)
...
`plans/sep/19-typesafety-and-dedup-residue/reports/command-code/2026-09-19-lib-folderize-group-a.md`
