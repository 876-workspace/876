...
Companion to `.grok/rules/platform-services.md` (bounded contexts),
`.grok/rules/customer-architecture.md` (who a customer is),
`.grok/rules/stripe-api-pattern.md` (resource shape), and
`.grok/rules/express-api.md` (module shape). The Stripe field catalogues and
